 ...
 */
class CRM_Mailingwork_Upgrader_Base {

  /**
   * @var CRM_Mailingwork_Upgrader_Base
   */
  ...
  public static function instance() {
    if (!self::$instance) {
      self::$instance = new CRM_Mailingwork_Upgrader(
        'at.greenpeace.mailingwork',
        E::path()
      );
    }
   ...
   *
   * ```
   * CRM_Mailingwork_Upgrader_Base::_queueAdapter($ctx, 'methodName', 'arg1', 'arg2');
   * ```
   */
  ...
  /**
   * CRM_Mailingwork_Upgrader_Base constructor.
   *
   * @param $extensionName
   * @param $extensionDir
   */
