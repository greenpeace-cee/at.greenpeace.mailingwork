...
/**
 * MailingworkOpening.import API specification (optional)
 ...
 */
function _civicrm_api3_mailingwork_opening_import_spec(&$spec) {
  $spec['soft_limit'] = [
    'name'         => 'soft_limit',
    'title'        => 'Soft limit',
    'description'  => 'Soft limit for number of openings to process.',
 ...
 * @throws \Exception
 */
function civicrm_api3_mailingwork_opening_import($params) {
  ...
  $processor = new CRM_Mailingwork_Processor_Greenpeace_Openings($params);
