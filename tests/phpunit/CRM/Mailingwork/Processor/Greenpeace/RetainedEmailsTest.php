 ...
 * @group headless
 */
class CRM_Mailingwork_Processor_Greenpeace_RetainedEmailsTest extends \PHPUnit_Framework_TestCase implements HeadlessInterface, HookInterface, TransactionalInterface {
